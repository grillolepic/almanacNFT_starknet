...
<style>
  ...
  #mainContainer {
    ...
    left: 0px;
    background: rgb(39 19 72);
    background: linear-gradient(0deg, rgb(39 19 72) 0%, rgba(18,11,43,1) 100%);
  }
  ...
  .green-btn {
    background-image: linear-gradient(45deg, #45dc4d, #6cb36a);
  }
  ...
  .orange-btn {
    background-image: linear-gradient(45deg, #dc9645, #b38b6a);
  }
